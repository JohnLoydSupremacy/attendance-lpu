...
<HTML>
    <HEAD>
        ...
        <title> Choose Event to Attend</title>
...
<select name="color" id="color">
	...
	<option value="blue">Blue</option>
            ...
            <div class="pswd">Note: Birthday (dd/mm/yyyy) </div>
            <input type="submit" value="Log in">
            <div class="signup">
                <a href="Attendance_Events.php"><img src="admin_icon.png " width="30" height="30" class="right" title="BAWAL SA TANGA"></a>
            </div>
                </form>
        </div> 
    </div>
